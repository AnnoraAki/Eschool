...
public final class LostAndFoundViewModel extends com.erookies.lib_common.base.BaseViewModel {
    ...
    @org.jetbrains.annotations.NotNull()
    public final androidx.lifecycle.MutableLiveData<java.util.List<com.erookies.lib_common.User>> getUsers() {
        return null;
    }
    
    public final void setUsers(@org.jetbrains.annotations.NotNull()
    androidx.lifecycle.MutableLiveData<java.util.List<com.erookies.lib_common.User>> p0) {
    }
    
    @org.jetbrains.annotations.NotNull()
    public final androidx.lifecycle.MutableLiveData<com.erookies.lib_common.User> getCurrentUser() {
        return null;
    }
    
    public final void setCurrentUser(@org.jetbrains.annotations.NotNull()
    androidx.lifecycle.MutableLiveData<com.erookies.lib_common.User> p0) {
    }
    ...
    public final void getItemByCurrentTag() {
    }
